		...
		mFuture = new FutureTask<Result>(mWorker) {
			...
			protected void done() {
				...
				try {
					...
					message.what = MESSAGE_POST_CANCEL;
...
//								result));
				...
				YoukuAsyncTaskResult resultMessage = new YoukuAsyncTaskResult<Result>(YoukuAsyncTask.this,result);
				
				switch (message.what) {
				case MESSAGE_POST_RESULT:
					// There is only one result
					resultMessage.mTask.finish(resultMessage.mData[0]);
					break;
				case MESSAGE_POST_PROGRESS:
					resultMessage.mTask.onProgressUpdate(resultMessage.mData);
					break;
				case MESSAGE_POST_CANCEL:
					resultMessage.mTask.onCancelled();
					break;
				}
	 ...
	 *             {@link YoukuAsyncTask.Status#RUNNING} or
	 *             {@link YoukuAsyncTask.Status#FINISHED}.
	 */
