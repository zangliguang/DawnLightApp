...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        if (!CaptureActivity.IsLandSpace) {
        	Logger.lxf("=======CamerConfiguration====initFromCameraParameters=======");
...
//        Log.e("degree", "degree:"+degree);
        Logger.lxf("=context.getResources().getConfiguration().orientation=="+context.getResources().getConfiguration().orientation);
        Logger.lxf("===degree=旋转度数======================================="+degree);
        if(!CaptureActivity.IsLandSpace){
    ...
    Point getScreenResolution() {
        int width =CaptureActivity.Wt;
        int height =CaptureActivity.HT;
        int title=(int)context.getResources().getDimension(R.dimen.homepage_title_height);
//        Log.i(TAG, "title: " + title);
        height=height-79-title;
